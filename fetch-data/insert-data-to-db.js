...
function addPlayer(p){
    db.query(`INSERT into players (no, player, pos, apps, mins, goals, assists, team, season) 
    VALUES ("?","?","?","?","?","?","?","?","?")`,
    [p.no, p.player, p.pos, p.apps, p.mins, p.goals,p.assists, p.team, season]);
};
function addTeam(t){
    db.query(`INSERT into teams (no, team, matches, wins, draws, loses, goals_for, goals_against, pts, league, season) 
    VALUES ("?","?","?","?","?","?","?","?","?", "?", "?")`,
